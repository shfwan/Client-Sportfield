...
export const RadioButton = ({ className, children, dateDay, index, ...props }) => {
    ...
    return (
        <label className={`${className} btn min-w-28 p-2 h-full btn-outline border-gray-400 hover:bg-transparent hover:shadow-md ${value == props.value ? "bg-success/10 text-white border-success" : ""}`}>
